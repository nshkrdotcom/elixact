defmodule Elixact.Wrapper do
  ...
  ## Examples
      ...
      iex> wrapper = Elixact.Wrapper.create_wrapper(:result, :integer, coerce: true, constraints: [gt: 0])
      %Elixact.Runtime.DynamicSchema{...}

      iex> wrapper = Elixact.Wrapper.create_wrapper(:email, :string,
  ...
  ## Examples
      ...
      iex> wrapper = Elixact.Wrapper.create_wrapper(:count, :integer, coerce: true)
      iex> Elixact.Wrapper.validate_and_extract(wrapper, %{count: "42"}, :count)
      {:ok, 42}

      iex> Elixact.Wrapper.validate_and_extract(wrapper, "42", :count)  # Auto-wrap
      {:ok, 42}

      iex> Elixact.Wrapper.validate_and_extract(wrapper, %{count: "abc"}, :count)
      {:error, [%Elixact.Error{...}]}
  """
  ...
  ## Examples
      ...
      iex> Elixact.Wrapper.wrap_and_validate(:score, :integer, "85", coerce: true, constraints: [gteq: 0, lteq: 100])
      {:ok, 85}

      iex> Elixact.Wrapper.wrap_and_validate(:email, :string, "invalid", constraints: [format: ~r/@/])
      {:error, [%Elixact.Error{...}]}

      iex> Elixact.Wrapper.wrap_and_validate(:items, {:array, :string}, ["a", "b", "c"])
      {:ok, ["a", "b", "c"]}
  """
  ...
  ## Examples
      ...
      iex> wrappers = %{
      ...>   name: Elixact.Wrapper.create_wrapper(:name, :string),
      ...>   age: Elixact.Wrapper.create_wrapper(:age, :integer)
      ...> }
      iex> data = %{name: "John", age: 30}
      iex> Elixact.Wrapper.validate_multiple(wrappers, data)
      {:ok, %{name: "John", age: 30}}
  """
  ...
  ## Examples
      ...
      iex> email_wrapper_factory = Elixact.Wrapper.create_wrapper_factory(
      ...>   :string,
  ...
  ## Examples
      ...
      iex> wrapper = Elixact.Wrapper.create_wrapper(:count, :integer, constraints: [gt: 0])
      iex> Elixact.Wrapper.to_json_schema(wrapper)
      %{
        "type" => "object",
        "properties" => %{
  ...
  ## Examples
      ...
      iex> Elixact.Wrapper.unwrap_result(validated, :score)
      85
  """
  ...
  ## Examples
      ...
      iex> Elixact.Wrapper.wrapper_schema?(wrapper)
      true

      iex> regular_schema = Elixact.Runtime.create_schema([{:name, :string}])
      iex> Elixact.Wrapper.wrapper_schema?(regular_schema)
      false
  """
  ...
  ## Examples
      ...
      iex> wrapper = Elixact.Wrapper.create_wrapper(:email, :string, description: "User email")
      iex> Elixact.Wrapper.wrapper_info(wrapper)
      %{
        is_wrapper: true,
        field_name: :email,
        field_count: 1,
  ...
  ## Examples
      ...
      iex> wrapper = Elixact.Wrapper.create_flexible_wrapper(:age, :integer, coerce: true)
      iex> Elixact.Wrapper.validate_flexible(wrapper, 25, :age)        # Raw value
      {:ok, 25}
      iex> Elixact.Wrapper.validate_flexible(wrapper, %{age: 25}, :age) # Map with atom key
      {:ok, 25}
