defmodule Elixact.Runtime.EnhancedSchema do
  @moduledoc """
  ...
  alias Elixact.{ComputedFieldMeta, Error}
  ...
  @type computed_field_spec :: {atom(), Elixact.Types.type_definition(), validator_spec}
  ...
  ## Examples
      ...
      iex> schema = Elixact.Runtime.EnhancedSchema.create(fields,
  ...
  def create(field_definitions, opts \\ []) do
    ...
    # Create base schema
    base_schema = Elixact.Runtime.create_schema(field_definitions, base_opts)
  ...
  ## Examples
      ...
      iex> Elixact.Runtime.EnhancedSchema.validate(data, schema)
  ...
  def validate(data, %__MODULE__{} = enhanced_schema, opts \\ []) do
    ...
    case Elixact.Runtime.validate(data, enhanced_schema.base_schema, opts) do
      {:ok, validated_fields} ->
  ...
  ## Examples
      ...
      iex> json_schema = Elixact.Runtime.EnhancedSchema.to_json_schema(schema)
      %{
        "type" => "object",
        "properties" => %{
          "name" => %{"type" => "string"},
  ...
  def to_json_schema(%__MODULE__{} = enhanced_schema, opts \\ []) do
    ...
    base_json = Elixact.Runtime.to_json_schema(enhanced_schema.base_schema, opts)
  ...
  defp process_single_computed_field({field_name, field_type, {module, function_name}}, functions)
    ...
    computed_meta = %ComputedFieldMeta{
      name: field_name,
      type: Elixact.Types.normalize_type(field_type),
      ...
      {field_name, computed_meta}, {:ok, current_data} ->
        ...
        case execute_computed_field(
          ...
          {:ok, computed_value} ->
            ...
            case Elixact.Validator.validate(computed_meta.type, computed_value, field_path) do
              {:ok, validated_value} ->
