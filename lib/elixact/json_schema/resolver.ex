defmodule Elixact.JsonSchema.Resolver do
  ...
  ## Examples
      ...
      ...>   }
      ...> }
      iex> Elixact.JsonSchema.Resolver.resolve_references(schema)
      %{
        "type" => "object",
        "properties" => %{
          "user" => %{"type" => "object", "properties" => %{"name" => %{"type" => "string"}}}
  ...
  ## Examples
      ...
      ...>   }
      ...> }
      iex> Elixact.JsonSchema.Resolver.flatten_schema(schema)
      %{
        "type" => "object",
        "properties" => %{
          "items" => %{
  ...
  ## Examples
      ...
      iex> Elixact.JsonSchema.Resolver.enforce_structured_output(schema, provider: :openai)
  ...
  ## Examples
      ...
      iex> Elixact.JsonSchema.Resolver.optimize_for_llm(schema, remove_descriptions: true)
