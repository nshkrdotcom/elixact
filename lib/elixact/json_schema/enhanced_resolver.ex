defmodule Elixact.JsonSchema.EnhancedResolver do
  ...
  - Seamlessly integrates all Elixact features (struct patterns, model validators, computed fields)
  ...
  Handles all Elixact schema types:
  ...
  ## Examples
      ...
      ...>   end
      ...> end
      iex> schema = Elixact.JsonSchema.EnhancedResolver.resolve_enhanced(TestSchema)
      iex> schema["type"]
      "object"
      iex> schema["x-elixact-enhanced"]
      true
  """
  ...
  def resolve_enhanced(schema_or_spec, opts \\ []) do
    ...
    enhanced_schema =
      ...
      |> add_elixact_enhanced_metadata(schema_or_spec)
  ...
  ## Examples
      ...
      ...>   end
      ...> end
      iex> report = Elixact.JsonSchema.EnhancedResolver.comprehensive_analysis(AnalysisTestSchema)
  ...
  ## Examples
      ...
      ...>   end
      ...> end
      iex> dspy_schema = Elixact.JsonSchema.EnhancedResolver.optimize_for_dspy(DSPyTestSchema)
  ...
  ## Examples
      ...
      ...>   end
      ...> end
      iex> Elixact.JsonSchema.EnhancedResolver.validate_schema_compatibility(CompatibilityTestSchema)
      :ok
  """
  ...
  defp generate_base_enhanced_schema(schema_module, _opts) when is_atom(schema_module) do
    if function_exported?(schema_module, :__schema__, 1) do
      Elixact.JsonSchema.from_schema(schema_module)
    else
      # Type specification
      Elixact.TypeAdapter.json_schema(schema_module)
    end
  end
  ...
  @spec add_elixact_enhanced_metadata(map(), module() | DynamicSchema.t() | EnhancedSchema.t()) ::
          map()
  defp add_elixact_enhanced_metadata(schema, schema_source) do
    schema
    |> Map.put("x-elixact-enhanced", true)
    |> Map.put("x-elixact-version", get_elixact_version())
  ...
  defp maybe_remove_computed_fields_for_dspy(schema, true) do
    Elixact.JsonSchema.remove_computed_fields(schema)
  end
  ...
  defp determine_schema_type(_), do: :type_specification
  ...
  @spec get_elixact_version() :: String.t()
  defp get_elixact_version do
    case Application.spec(:elixact, :vsn) do
      nil -> "unknown"
      vsn -> to_string(vsn)
    end
  end
