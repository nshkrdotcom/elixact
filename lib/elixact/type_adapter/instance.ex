defmodule Elixact.TypeAdapter.Instance do
  ...
  @type t :: %__MODULE__{
          ...
          normalized_type: Elixact.Types.type_definition(),
          config: map(),
          json_schema: map() | nil
        }
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new({:array, :integer}, coerce: true)
      %Elixact.TypeAdapter.Instance{...}
  """
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new(:string)
      iex> Elixact.TypeAdapter.Instance.validate(adapter, "hello")
      {:ok, "hello"}

      iex> adapter = Elixact.TypeAdapter.Instance.new(:integer, coerce: true)
      iex> Elixact.TypeAdapter.Instance.validate(adapter, "123")
      {:ok, 123}
  """
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new({:map, {:string, :any}})
      iex> Elixact.TypeAdapter.Instance.dump(adapter, %{name: "John"})
      {:ok, %{"name" => "John"}}
  """
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new(:string)
      iex> Elixact.TypeAdapter.Instance.json_schema(adapter)
      %{"type" => "string"}
  """
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new(:string)
      iex> updated = Elixact.TypeAdapter.Instance.update_config(adapter, %{coerce: true})
      %Elixact.TypeAdapter.Instance{config: %{coerce: true, ...}}
  """
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new({:array, :string})
      iex> Elixact.TypeAdapter.Instance.info(adapter)
      %{
  ...
  ## Examples
      ...
      iex> adapter = Elixact.TypeAdapter.Instance.new(:integer)
      iex> Elixact.TypeAdapter.Instance.validate_many(adapter, [1, 2, 3])
      {:ok, [1, 2, 3]}
