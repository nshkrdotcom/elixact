defmodule Elixact.Config.Builder do
  @moduledoc """
  Fluent builder for creating Elixact configurations.
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.strict()
      %Elixact.Config.Builder{opts: %{strict: true}}

      iex> builder |> Elixact.Config.Builder.strict(false)
      %Elixact.Config.Builder{opts: %{strict: false}}
  """
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.extra(:forbid)
      %Elixact.Config.Builder{opts: %{extra: :forbid}}
  """
  @spec extra(t(), Elixact.Config.extra_strategy()) :: t()
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.coercion(:safe)
      %Elixact.Config.Builder{opts: %{coercion: :safe}}
  """
  @spec coercion(t(), Elixact.Config.coercion_strategy()) :: t()
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.frozen()
      %Elixact.Config.Builder{opts: %{frozen: true}}
  """
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.validate_assignment()
      %Elixact.Config.Builder{opts: %{validate_assignment: true}}
  """
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.error_format(:simple)
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.case_sensitive()
      %Elixact.Config.Builder{opts: %{case_sensitive: true}}

      iex> builder |> Elixact.Config.Builder.case_sensitive(false)
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.max_union_length(3)
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.title_generator(title_fn)
      %Elixact.Config.Builder{opts: %{title_generator: #Function<...>}}
  """
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.description_generator(desc_fn)
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.use_enum_values()
      %Elixact.Config.Builder{opts: %{use_enum_values: true}}
  """
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.merge(%{strict: true, frozen: true})
  ...
  ## Parameters
    * `builder` - The builder instance
    * `preset` - The preset name (same as Elixact.Config.preset/1)
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.apply_preset(:strict)
  ...
  def apply_preset(%__MODULE__{} = builder, preset) do
    preset_config = Elixact.Config.preset(preset)
  ...
  ## Returns
    * Elixact.Config struct with the configured options

  ## Examples

      iex> config = Elixact.Config.Builder.new()
  ...
  """
  @spec build(t()) :: Elixact.Config.t()
  def build(%__MODULE__{} = builder) do
    Elixact.Config.create(builder.opts)
  end
  ...
  ## Examples
      ...
      iex> valid_builder = Elixact.Config.Builder.new() |> Elixact.Config.Builder.strict()
      iex> Elixact.Config.Builder.validate_and_build(valid_builder)
      {:ok, %Elixact.Config{...}}

      iex> invalid_builder = Elixact.Config.Builder.new()
      ...> |> Elixact.Config.Builder.strict()
      ...> |> Elixact.Config.Builder.allow_extra()
      iex> Elixact.Config.Builder.validate_and_build(invalid_builder)
      {:error, ["strict mode conflicts with extra: :allow"]}
  """
  @spec validate_and_build(t()) :: {:ok, Elixact.Config.t()} | {:error, [String.t()]}
  ...
  ## Examples
      ...
      iex> builder |> Elixact.Config.Builder.when_true(is_production, &Elixact.Config.Builder.frozen/1)
      %Elixact.Config.Builder{...}

      iex> builder |> Elixact.Config.Builder.when_true(true, fn b ->
      ...>   b |> Elixact.Config.Builder.strict() |> Elixact.Config.Builder.forbid_extra()
      ...> end)
      %Elixact.Config.Builder{opts: %{strict: true, extra: :forbid}}
  """
  ...
  ## Examples
      ...
      iex> builder = Elixact.Config.Builder.new() |> Elixact.Config.Builder.strict()
      iex> Elixact.Config.Builder.summary(builder)
  ...
  ## Examples
      ...
      iex> builder = Elixact.Config.Builder.new() |> Elixact.Config.Builder.strict()
      iex> reset_builder = Elixact.Config.Builder.reset(builder)
      %Elixact.Config.Builder{opts: %{}}
  """
  @spec reset(t()) :: t()
  ...
  ## Examples
      ...
      iex> original = Elixact.Config.Builder.new() |> Elixact.Config.Builder.strict()
      iex> cloned = Elixact.Config.Builder.clone(original)
      %Elixact.Config.Builder{opts: %{strict: true}}
  """
  @spec clone(t()) :: t()
