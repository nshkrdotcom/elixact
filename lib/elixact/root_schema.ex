defmodule Elixact.RootSchema do
  @moduledoc """
  ...
  ## Options
    ...
    * `:root` - The type definition for the root value. This can be any valid
      Elixact type definition including basic types, arrays, maps, unions, etc.
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      """
      @spec validate(term()) :: {:ok, term()} | {:error, Elixact.Error.t() | [Elixact.Error.t()]}
      def validate(data) do
        Elixact.RootSchema.validate_root(@root_type, data)
      end
      ...
      ## Returns
        ...
        * Raises `Elixact.ValidationError` on validation failures
      ...
      def validate!(data) do
        case validate(data) do
          ...
          {:error, errors} -> raise Elixact.ValidationError, errors: List.wrap(errors)
        end
      end
      ...
      def json_schema do
        Elixact.RootSchema.to_json_schema(@root_type)
      end
  ...
  @spec validate_root(term(), term()) ::
          {:ok, term()} | {:error, Elixact.Error.t() | [Elixact.Error.t()]}
