...
This directory contains comprehensive examples showcasing all of Elixact's features, from basic validation to advanced LLM integration and DSPy patterns.
...
|> Elixact.JsonSchema.Resolver.optimize_for_provider(:openai)
```
