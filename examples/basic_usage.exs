# Basic Usage Examples for Elixact

# This file demonstrates the fundamental features of Elixact
# Run with: `mix run examples/basic_usage.exs`

# Compile and load the Elixact modules
...
defmodule BasicUsageExamples do
  ...
  def run do
    IO.puts("=== Basic Elixact Usage Examples ===\n")
