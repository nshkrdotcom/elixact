...
# Demonstrates comprehensive patterns for computed fields in Elixact schemas

defmodule ComputedFieldsExamples do
  @moduledoc """
  Complete examples for computed fields functionality in Elixact.
  ...
  defmodule RuntimeComputedFields do
    def create_enhanced_user_schema do
      ...
      Elixact.Runtime.create_enhanced_schema(fields,
  ...
  def run_examples do
    ...
    case Elixact.Runtime.validate_enhanced(user_social_data, enhanced_schema) do
      {:ok, enhanced_user} ->
