defmodule Elixact.RootSchemaTest do
  use ExUnit.Case, async: true

  alias Elixact.TypeAdapter.Instance
  alias Elixact.ValidationError
  ...
  describe "basic RootSchema usage" do
    ...
    defmodule StringSchema do
      use Elixact.RootSchema, root: :string
    end
  ...
  describe "complex type RootSchemas" do
    ...
    defmodule TupleSchema do
      use Elixact.RootSchema, root: {:tuple, [:string, :integer, :boolean]}
    end
  ...
  describe "schema reference RootSchemas" do
    ...
    defmodule SingleUserSchema do
      use Elixact.RootSchema, root: UserSchema
    end
  ...
  describe "error handling" do
    ...
    test "provides meaningful error messages" do
      defmodule NumberSchema do
        use Elixact.RootSchema, root: :integer
      end
  ...
  describe "integration with existing Elixact features" do
    ...
    defmodule PersonListSchema do
      use Elixact.RootSchema, root: {:array, PersonSchema}
    end

    test "works with TypeAdapter" do
      # Create a TypeAdapter for the same type
      adapter = Elixact.TypeAdapter.create({:array, :integer})
  ...
  describe "JSON Schema generation edge cases" do
    defmodule AnyTypeSchema do
      use Elixact.RootSchema, root: :any
    end

    defmodule MapSchema do
      use Elixact.RootSchema, root: :map
    end
