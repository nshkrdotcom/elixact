defmodule Elixact.SchemaEnhancedFeaturesTest do
  ...
  describe "JSON Schema generation with enhanced features" do
    test "generates JSON schema for atom types with choices" do
      json_schema = Elixact.JsonSchema.from_schema(__MODULE__.UserProfileSchema)
    ...
    test "generates JSON schema for object types" do
      json_schema = Elixact.JsonSchema.from_schema(__MODULE__.ProductSchema)
