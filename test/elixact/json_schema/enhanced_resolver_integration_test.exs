defmodule Elixact.JsonSchema.EnhancedResolverIntegrationTest do
  ...
  describe "end-to-end integration" do
    test "complete workflow: schema definition -> enhancement -> validation -> JSON schema" do
      ...
      assert enhanced_schema["x-elixact-enhanced"] == true
    ...
    test "edge cases and error handling" do
      ...
      assert legacy_schema["x-elixact-enhanced"] == true
    end
    ...
    test "LLM provider compatibility and optimization" do
      ...
      assert openai_schema["x-elixact-enhanced"] == true
      ...
      assert anthropic_schema["x-elixact-enhanced"] == true
      ...
      assert generic_schema["x-elixact-enhanced"] == true
    ...
    test "backward compatibility with existing resolvers" do
      ...
      legacy_json_schema = Elixact.JsonSchema.from_schema(LegacyStyleSchema)
      ...
      assert Map.has_key?(enhanced_json_schema, "x-elixact-enhanced")
      refute Map.has_key?(legacy_json_schema, "x-elixact-enhanced")
    end
  end
