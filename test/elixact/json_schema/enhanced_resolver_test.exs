...
# File: test/elixact/json_schema/enhanced_resolver_test.exs

defmodule Elixact.JsonSchema.EnhancedResolverTest do
  ...
  defmodule FullFeaturedSchema do
    ...
    schema "Schema with all features" do
      ...
      config do
        ...
        config_description("Demonstrates all Elixact features")
        strict(true)
      end
    end
  ...
  describe "comprehensive_analysis/3" do
    test "provides complete analysis for full-featured schema" do
      ...
      assert report.json_schema["x-elixact-enhanced"] == true
  ...
  describe "integration with existing functionality" do
    ...
    test "maintains backward compatibility with existing resolvers" do
      ...
      assert enhanced_resolved["x-elixact-enhanced"] == true
      refute Map.has_key?(standard_resolved, "x-elixact-enhanced")
    end
  end
