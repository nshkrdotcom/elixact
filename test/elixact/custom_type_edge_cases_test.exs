defmodule Elixact.CustomTypeEdgeCasesTest do
  ...
  describe "custom type definition edge cases" do
      ...
      defmodule ComplexCustomType do
        ...
        def type_definition do
          Elixact.Types.union([
            ...
            Elixact.Types.array(Elixact.Types.integer())
            |> Elixact.Types.with_constraints([
              {:min_items, 3},
              {:max_items, 10}
            ])
    ...
    test "handles custom type with coercion rules" do
      ...
      # Test coercion works - the base Elixact.Type implementation handles this
    ...
    test "handles custom type with module reference coercion" do
      ...
      defmodule ModuleCoercionType do
        ...
        def type_definition do
          # This is a bit contrived since atoms aren't basic types in Elixact
          Elixact.Types.string()
        end
      ...
      defmodule NestedCustomType do
        ...
        def type_definition do
          ...
          Elixact.Types.array(
            Elixact.Types.map(
              Elixact.Types.string(),
              Elixact.Types.array(Elixact.Types.string())
            )
          )
        end
