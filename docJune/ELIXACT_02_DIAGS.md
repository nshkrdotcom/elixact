# Elixact Architecture Diagrams

### Diagram 1: Overall Architecture & Module Dependencies

This diagram shows the high-level components of the Elixact library and their primary dependencies. The architecture is layered, with the `EnhancedValidator` serving as a unified entry point that delegates to specialized modules.
