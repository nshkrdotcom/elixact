# Complete Test Suite for Elixact Enhanced Features
...
defmodule Elixact.TestSupport.EnhancedSchemas do
  @moduledoc """
...
defmodule Elixact.StructPatternTest do
  use ExUnit.Case
  alias Elixact.TestSupport.EnhancedSchemas.{BasicStructSchema, NoStructSchema}
...
defmodule Elixact.ModelValidatorsTest do
  use ExUnit.Case
  alias Elixact.TestSupport.EnhancedSchemas.{
...
defmodule Elixact.ComputedFieldsTest do
  use ExUnit.Case
  alias Elixact.TestSupport.EnhancedSchemas.{ComputedFieldsSchema, ErrorComputedFieldSchema}
...
defmodule Elixact.EnhancedSchemaValidatorTest do
  use ExUnit.Case
  alias Elixact.EnhancedSchemaValidator
  alias Elixact.TestSupport.EnhancedSchemas.{BasicStructSchema, CompleteSchema}
...
defmodule Elixact.EnhancedRuntimeTest do
  use ExUnit.Case
...
defmodule Elixact.EnhancedFeaturesIntegrationTest do
  use ExUnit.Case
  alias Elixact.TestSupport.EnhancedSchemas.CompleteSchema
...
defmodule Elixact.EnhancedFeaturesPropertyTest do
  use ExUnit.Case
  use PropCheck
...
defmodule Elixact.EnhancedFeaturesPerformanceTest do
  use ExUnit.Case
...
defmodule Elixact.EnhancedFeaturesEdgeCasesTest do
  use ExUnit.Case
...
defmodule Elixact.EnhancedFeaturesJsonSchemaTest do
  use ExUnit.Case
  alias Elixact.{JsonSchema, Runtime}
